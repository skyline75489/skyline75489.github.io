...
除了语法层面的要求之外，使用 C\+\+/CLI 进行 Native 互操作编程，还要求开发人员在有 C/C\+\+ 的语言的编程经验的基础之上，有 .NET 平台调用非托管代码的经验。尽管 C\+\+/CLI 和 Native 混合编程部分的代码看起来简单，但是实际上却隐含了对于托管代码和非托管代码交互的正确理解。综合这些因素，相比 C# 的 P/Invoke 技术，C\+\+/CLI 的学习曲线可以说是十分陡峭了。
